...
import { useUser, useDoc, useFirestore, useMemoFirebase, useCollection, FirestorePermissionError, errorEmitter } from "@/firebase";
...
export default function AdminCourtsPage() {
    ...
    const handleSaveChanges = async () => {
        ...
        const updatePromises = courts.map(court => {
            ...
            const updatedData = { ...court, price: prices[court.id] || 0 };
            
            return setDoc(courtRef, updatedData, { merge: true })
                .catch(error => {
                    ...
                    // Return the error to be identified in Promise.allSettled
            ...
            <Card className="bg-card/80 backdrop-blur-sm w-full max-w-2xl">
                ...
                <CardContent>
                    <div className="space-y-6">
                       {courts && courts.sort((a,b) => a.courtNumber - b.courtNumber).map(court => (
